  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-16 sm:pt-20 pb-8 sm:pb-10 z-10 relative">
        ...
        {/* Name — dorado con efectos premium y reflejo espejado */}
        <h1
          className="leading-tight mb-8 sm:mb-10 px-2 text-mirrored-shine relative z-10 text-center select-text"
          style={{
            ...
            textShadow: "0 0 25px rgba(212, 185, 106, 0.4), 0 2px 4px rgba(45, 90, 45, 0.1)",
          }}
        >
          julieta
        </h1>
