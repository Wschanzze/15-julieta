    ...
    <section className="relative min-h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-16 sm:pt-20 pb-8 sm:pb-10 z-10 relative">
        ...
        <div className="relative w-full max-w-4xl mx-auto flex items-center justify-center my-8 sm:my-12 py-10 select-none">
          ...
          {/* ========================================================
              CAPA DE FONDO (z-0) - Lecho floral denso detrás del texto
              ======================================================== */}
          <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
            
            {/* 1. Centro-Izquierda Fondo (Grupo03.png) */}
            <div className="absolute left-[25%] sm:left-[30%] top-1/2 -translate-y-1/2 -translate-x-1/2 w-40 h-40 sm:w-60 sm:h-60 md:w-72 md:h-72 opacity-95">
            ...
            {/* 2. Centro-Derecha Fondo (Grupo03.png invertido) */}
            <div className="absolute right-[25%] sm:right-[30%] top-1/2 -translate-y-1/2 translate-x-1/2 w-40 h-40 sm:w-60 sm:h-60 md:w-72 md:h-72 opacity-95">
              <div className="w-full h-full animate-sway-slow">
                <img
                  src="/Flores/Grupo03.png"
                  alt=""
            ...
            {/* 3. Extremo Izquierda Fondo (Grupo02_c.png) */}
            <div className="absolute left-[8%] sm:left-[12%] top-[45%] -translate-y-1/2 -translate-x-1/2 w-32 h-32 sm:w-48 sm:h-48 md:w-56 md:h-56 opacity-90">
            ...
            {/* 4. Extremo Derecha Fondo (Grupo01_c.png) */}
            <div className="absolute right-[8%] sm:right-[12%] top-[45%] -translate-y-1/2 translate-x-1/2 w-32 h-32 sm:w-48 sm:h-48 md:w-56 md:h-56 opacity-90">
            ...
            {/* 5. Superior Centro Fondo (Grupo02_a.png) */}
            <div className="absolute top-[5%] left-1/2 -translate-x-1/2 w-36 h-36 sm:w-52 sm:h-52 md:w-60 md:h-60 opacity-85">
            ...
            {/* 6. Inferior Centro Fondo (Grupo02_b.png) */}
            <div className="absolute bottom-[5%] left-1/2 -translate-x-1/2 w-32 h-32 sm:w-48 sm:h-48 md:w-56 md:h-56 opacity-85">
              <div className="w-full h-full animate-sway-delicate">
                <img
          ...
          <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none">
            ...
            {/* 7. Superposición Izquierda sobre la letra 'J' (Grupo02_b.png) */}
            ...
            {/* 8. Superposición Derecha sobre la letra 'a' (Grupo02_a.png) */}
