  ...
  return (
    <section className="relative py-20 px-6 overflow-hidden">
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <p className="text-base font-light text-muted-foreground italic mb-10">
          Si deseás regalarme algo más que tu hermosa presencia...
        </p>

        {/* Gift icon */}
        <div className="mb-8 opacity-70">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
